...
int max_blv_exp_gain = 255; // when player reach this BaseLevel, they stop gain BaseExp
int max_jlv_exp_gain = 80; // when player reach this JobLevel, they stop gain JobExp
